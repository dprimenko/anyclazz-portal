...
import type { GetPaymentHistoryResponse } from '../../domain/paymentHistoryTypes';

const ITEMS_PER_PAGE = 10;

export interface PaginatedPaymentsProps {
    initialPayments: GetPaymentHistoryResponse;
    accessToken: string;
    lang?: string;
}

export const PaginatedPayments: FC<PaginatedPaymentsProps> = ({
    initialPayments,
    accessToken,
    lang,
}) => {
